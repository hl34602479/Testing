...
public class AccordionIndexPage  extends BasePage implements DefaultPage {
    ...
    final By headerAccordionText = By.xpath("//h1[.='Click on One of the Accordian Items Below!']");
